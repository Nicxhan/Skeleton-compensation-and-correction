...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='C:/users/Han/Desktop/st-gcn/st-gcn-master/data/Kinetics/kinetics-skeleton')
    parser.add_argument(
        '--out_folder', default='C:/users/Han/Desktop/st-gcn/st-gcn-master/data/Kinetics/kinetics-skeleton')
